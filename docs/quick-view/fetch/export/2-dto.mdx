...
> This article only provides a quick overview without detailed introduction. For complete information, please refer to [DTO Language](../../../object/view/dto-language)  
...
The [DTO Language](../../../object/view/dto-language) also supports document comments. For example:
...
:::info
The document comment of the [DTO Language](../../../object/view/dto-language) has higher priority.   
